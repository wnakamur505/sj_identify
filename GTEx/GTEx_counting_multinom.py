...
files = glob.glob("/home/ubuntu/environment/raw_data/GTEx.rna.Blood.Wholo_Blood/GTEX-*.SJ.out.annot.tab.gz")
...
#for line in file:
    ...
    m = re.match("(/home/ubuntu/environment/raw_data/GTEx.rna.Blood.Whole_Blood/)(GTEX.*)(.SJ.out.annot.tab.gz)",line)
    #m = re.match("(/work/GTEx.rna.Muscle.Muscle-Skeletal/)(GTEX.*)(.SJ.out.annot.tab)",line)
