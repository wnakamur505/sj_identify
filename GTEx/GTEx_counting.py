...
with open("/home/ubuntu/environment/GTEx_file/files/GTEx_group_GRCh37.txt","r") as hin: 
...
files = glob.glob("/home/ubuntu/environment/raw_data/GTEx.rna.Blood.Wholo_Blood/GTEX-*.SJ.out.tab.gz")
